...
const std::string &RequestVO::getUri() const
{
    return uri_;
}

void RequestVO::setUri(const std::string &uri)
{
    uri_ = uri;
}

const std::string &RequestVO::getMethod() const
{
    return method_;
}

void RequestVO::setMethod(const std::string &method)
{
    method_ = method;
}

const std::string &RequestVO::getVersion() const
{
    return version_;
}

void RequestVO::setVersion(const std::string &version)
{
    version_ = version;
}

const std::string &RequestVO::getBody() const
{
    return body_;
}

void RequestVO::setBody(const std::string &body)
{
    body_ = body;
}

void RequestVO::appendBody(const std::string &body)
{
    body_ += body;
}
